...
# Utiliser Cloud-Init pour configurer l'IP et le nom d'hôte unique
  ...
  ipconfig0 = var.interfaces_clusters_ip0_master  # Remplacez par votre passerelle réseau
  ipconfig1 = var.interfaces_clusters_ip1_master
